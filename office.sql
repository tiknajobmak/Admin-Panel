...
--
-- Host: localhost
-- Generation Time: Jul 29, 2015 at 06:35 AM
...
INSERT INTO `logTbl` (`logId`, `logIp`, `logDate`) VALUES
(1, '127.0.0.1', '2015-07-20'),
(2, '127.0.0.1', '2015-07-21'),
(3, '127.0.0.1', '2015-07-22'),
(4, '127.0.0.1', '2015-07-23'),
(5, '127.0.0.1', '2015-07-24'),
(6, '127.0.0.1', '2015-07-27'),
(7, '127.0.0.1', '2015-07-28');
...
INSERT INTO `menu` (`menuId`, `menuName`, `menuTitle`) VALUES
(17, 'maine-menu-updates-no', 'Maine Menu updates no'),
(18, 'menu-footer-new', 'Menu Footer New'),
(19, 'footer-upper', 'Footer Upper');

-- --------------------------------------------------------

--
-- Table structure for table `menuMeta`
--

CREATE TABLE IF NOT EXISTS `menuMeta` (
  `menuMetaId` int(11) NOT NULL AUTO_INCREMENT,
  `menuMenuId` int(11) NOT NULL,
  `menuPageId` int(11) NOT NULL DEFAULT '0',
  `menuParent` int(11) NOT NULL,
  `menuPosition` int(11) NOT NULL,
  PRIMARY KEY (`menuMetaId`),
  KEY `menuMenuId` (`menuMenuId`),
  KEY `menuMenuId_2` (`menuMenuId`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=49 ;

--
-- Dumping data for table `menuMeta`
--

INSERT INTO `menuMeta` (`menuMetaId`, `menuMenuId`, `menuPageId`, `menuParent`, `menuPosition`) VALUES
(29, 17, 12, 0, 1),
(30, 17, 14, 29, 2),
(31, 17, 15, 30, 3),
(39, 18, 3, 0, 1),
...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  `notSlug` varchar(500) NOT NULL,
  `notDisplayId` int(11) NOT NULL,
  `notType` varchar(10) NOT NULL,
  `notDate` datetime NOT NULL,
  `notStatus` tinyint(4) NOT NULL,
  PRIMARY KEY (`notId`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;
...
INSERT INTO `notifications` (`notId`, `notUserId`, `notSlug`, `notDisplayId`, `notType`, `notDate`, `notStatus`) VALUES
(1, 1, 'user/1', 1, 'user', '2015-07-22 03:00:00', 1),
(2, 1, 'pages/contactus', 1, 'page', '0000-00-00 00:00:00', 1),
(3, 1, 'pages/testing', 15, 'page', '2015-07-22 12:31:00', 1),
(4, 1, 'pages/home', 16, 'page', '2015-07-22 12:53:00', 1),
(5, 1, 'pages/newpage', 17, 'page', '2015-07-22 01:08:00', 1),
(6, 1, 'pages/about-us', 18, 'page', '2015-07-22 01:09:00', 1),
(7, 1, 'pages/new one', 19, 'page', '2015-07-23 08:54:00', 1);
...
(6, 'Date Test', 'date', '<p>`</p>\n\n<p>sdfsdfsdf sdfsd fsdf<br />\nSdf</p>\n\n<p>sd f</p>\n\n<p>&nbsp;sdf sdfsd</p>', 8, 1, '0000-00-00', 1, 5),
(7, 'Date Test 2', 'sdfdsf', '<p>asda a sdf df sdaf</p>', 1, 2, '2015-04-24', 1, 2),
...
(10, 'test', 'test', '<p>sdgdf</p>', 0, 1, '2015-04-30', 1, 0),
(12, 'Classes', 'classes', '<h3>About Classes</h3>\n\n<p>Student Registration and Administration Nemo enim ipsam voluptatem quia voluptas sit atur aut odit aut fugit, sed quia consequuntur magni res eos qui ratione voluptatem sequi nesciunt.</p>\n\n<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised believable.</p>', 0, 1, '2015-05-01', 1, 8),
(14, 'abc', '1', '', 0, 1, '2015-05-08', 1, 0),
(15, 'Test', 'testing', '<p>sdafsdfsdf</p>', 0, 1, '2015-07-22', 1, 3),
(16, 'notification page', 'home', '', 0, 1, '2015-07-22', 1, 4),
(17, 'New Page', 'newpage', '<p>Lets you set an ORDER BY clause. The first parameter contains the name of the column you would like to order by. The second parameter lets you set the direction of the result. Options are <kbd>asc</kbd> or <kbd>desc</kbd>, or <kbd>random</kbd>.</p>\n\n<p><code>$this-&gt;db-&gt;order_by(&quot;title&quot;, &quot;desc&quot;);<br />\n<br />\n// Produces: ORDER BY title DESC </code></p>', 0, 1, '2015-07-22', 1, 6),
(18, 'New', 'about-us', '', 0, 1, '2015-07-22', 1, 7),
(19, 'New on', 'new one', '<p>sdasa a efsdf sd fsd sdf sdf</p>', 0, 1, '2015-07-23', 1, 1);
...
CREATE TABLE IF NOT EXISTS `settings` (
  ...
  `siteOffline` tinyint(4) NOT NULL,
  `siteOfflineDesc` text NOT NULL,
...
INSERT INTO `settings` (`settingsId`, `contactEmail`, `gatewayApi`, `updatedBy`, `authorizeApiId`, `authorizeTransKey`, `siteOffline`, `siteOfflineDesc`) VALUES
(1, 'ankitphp@csgroupchd.com', 'ankitphp-seller@csgroupchd.com', 1, '8kK67CvDR', '24yRVX7j3vsy3M6X', 0, '<p>Site is on maintainance mode</p>\n');
...
(1, 'ankit', 'kamboj', 'admin', 'admin@gmail.com', 'YWRtaW5wYXNzd29yZGtleQ==', '1234567890', '123', '2015-04-02 10:34:16', 1, 'superadmin', '2015-07-28 12:18:04', '', ''),
(209, 'user', 'user', 'username', 'user@gmail.com', 'cGFzc3dvcmRrZXk=', '1234', '#1234', '2015-05-05 11:45:41', 0, 'user', '0000-00-00 00:00:00', '', ''),
...
(215, 'ss', 'as', 'activate', 'asda@gmail.com', 'MTIzNDU2cGFzc3dvcmRrZXk=', '', '', '2015-05-07 07:50:46', 1, 'user', '2015-07-21 06:41:14', 'activate.jpg', 'XDYufTEK4g'),
...
(303, 'Akki', 'kam', 'ankitkamboj17', 'ankit@gmail.com', 'MTIzNDU2Nzg5cGFzc3dvcmRrZXk=', '', '', '2015-07-21 04:39:01', 0, 'user', '0000-00-00 00:00:00', 'ankitkamboj17.jpg', 'Xtzjn0Gcep');
...
--
-- Constraints for table `menuMeta`
--
ALTER TABLE `menuMeta`
  ADD CONSTRAINT `menuMeta_ibfk_1` FOREIGN KEY (`menuMenuId`) REFERENCES `menu` (`menuId`) ON DELETE CASCADE ON UPDATE CASCADE;
