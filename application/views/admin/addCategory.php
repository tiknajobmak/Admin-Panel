                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 frm_add_user">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="frm_add_row">
                            <?php echo form_label('Category Name<span class="astrisk">*</span> :'); ?> <?php echo form_error('categoryName'); ?>
                        ...
                        <div class="frm_add_row">
                            ...
                            <?php echo form_submit(array('id' => 'cancel', 'url' => 'categories', 'value' => 'Cancel')); ?>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>
